  ...
  using phase_dependent_action_list = tmpl::list<
      ...
      Parallel::PhaseActions<
          ...
          tmpl::flatten<tmpl::list<
              // extra pre swsh derivative tags
              ::Actions::MutateApply<
                  PreSwshDerivatives<Tags::Dy<Tags::Dy<Tags::BondiJ>>>>,
              // extra precomputation tags
              ::Actions::MutateApply<PrecomputeCceDependencies<
                  Tags::BoundaryValue, Tags::OneMinusY>>,
