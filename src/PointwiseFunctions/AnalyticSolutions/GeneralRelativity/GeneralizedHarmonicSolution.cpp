...
template <typename SolutionType>
tuples::TaggedTuple<
    gr::Tags::Shift<GeneralizedHarmonic::Solutions::GeneralizedHarmonicSolution<
                        SolutionType>::volume_dim,
...
GeneralizedHarmonicSolution<SolutionType>::variables(
    ...
    const IntermediateVars& intermediate_vars) const noexcept {
  return {get<
      gr::Tags::Shift<GeneralizedHarmonic::Solutions::
                          GeneralizedHarmonicSolution<SolutionType>::volume_dim,
