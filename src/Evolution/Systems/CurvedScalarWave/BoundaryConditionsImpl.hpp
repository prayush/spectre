    ...
    switch (Method) {
      ...
      case VPsiBcMethod::ConstraintPreservingBjorhus:
        return apply_bjorhus_constraint_preserving(make_not_null(&bc_dt_u_psi),
                                                   lapse, shift, phi, pi);
      case VPsiBcMethod::ConstraintPreservingBjorhusDG:
      ...
      case VPsiBcMethod::ConstraintPreservingBjorhusDGDummy:
    ...
    switch (Method) {
      ...
      case VZeroBcMethod::ConstraintPreservingBjorhus:
        return apply_bjorhus_constraint_preserving(
            ...
            unit_normal_one_form);
      case VZeroBcMethod::ConstraintPreservingBjorhusDG:
        return apply_bjorhus_dg_constraint_preserving(
            ...
            one_over_dg_weight);
      case VZeroBcMethod::ConstraintPreservingBjorhusDGDummy:
        return apply_bjorhus_dg_dummy_constraint_preserving(
            make_not_null(&bc_dt_u_zero), deriv_lapse, deriv_shift, deriv_phi,
            deriv_pi, lapse, shift, phi, pi, unit_interface_normal_vector,
