...
///\file
/// Defines functions to calculate the constraint-damping coefficients
/// for the scalar-wave system in curved spacetime
...
namespace CurvedScalarWave::ConstraintDamping {
namespace Tags {
/*!
