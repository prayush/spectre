...
struct EvolutionMetavars {
  ...
  static constexpr bool local_time_stepping = false;  // FIXME
  using initial_data =
  ...
  using initialization_actions = tmpl::list<
      ...
      Initialization::Actions::GrTagsForHydro,  // FIXME
      Initialization::Actions::NonconservativeSystem,
      CurvedScalarWave::Actions::InitializeGrVars<system::volume_dim>,
  ...
  static constexpr OptionString help{
      ...
      "The analytic solution is: RegularSphericalWaveKerrSchild\n"
